...
@synthesize logEntry, logArray,managedObjectContext,logTable,fetchedResultsController;
@synthesize primaryLabel,secondaryLabel, editButton,emailButton;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    logEntry = [[ViewLogEntry alloc] init];
    logEntry.miles = mil;
    
    [tableView deselectRowAtIndexPath:indexPath animated:YES];
    
    [self.navigationController pushViewController:logEntry animated:YES];
...
-(IBAction) EmailTable:(id)sender{
    ...
    bodyMessage = @"Attached is your mileage log file";
    ...
    path = [path stringByAppendingPathComponent:@"mileageLog.txt"];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:path])		//Does file exist?
    {
        ...
        NSString* str = (@"mileageLog-%@.txt",[formatter stringFromDate:date]);
        
        [controller addAttachmentData:myData mimeType:@"application/octet-stream" fileName:str];
        
    }
    
	[controller setSubject:@"Your Mileage Log"];
