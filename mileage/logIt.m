...
@synthesize managedObjectContext, picker, dataArray;
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    ...
    if ((textField.tag & 1) == 0) {
        ...
        // Do aggressive memory management by making the pickers on demand. Memory released in slideDownDidStop.
        ...
        //If picker is already displaye remove it
        if(self.picker.superview != nil){
        	[self.picker removeFromSuperview];
            self.picker = nil;
        }
